...
class MinesweeperAI():
    ...
    def make_random_move(self):
        ...
        The move must not be a known mine or a move already made.
        """
        all_cells = set(
            (x, y) for x in range(self.width) for y in range(self.height)
        )
        com=self.moves_made | self.mines
        # Cells not yet moved to and not known to be mines
        valid_moves = all_cells-com
